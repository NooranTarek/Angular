...
import { DiscountPipePipe } from '../discount-pipe.pipe.js';
...
export class ShowProductDetailsComponent implements OnInit {
  ...
  ngOnInit() {
    console.log(this.id);
    // const activated_route_id = this.activeRoute.snapshot.params['id'];

    this.productsDetails = this.products.find(
      (product: Product) => product.id === parseInt(this.id)
    );
  }
}
