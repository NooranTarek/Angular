...
import { UsersListCardComponent } from '../users-list-card/users-list-card.component.js';

@Component({
  selector: 'app-users-list-info',
  standalone: true,
  imports: [UsersListCardComponent],
  templateUrl: './users-list-info.component.html',
  styleUrl: './users-list-info.component.css'
})
export class UsersListInfoComponent {
  users=[
    {
      "id": 1,
      "age": 50,
